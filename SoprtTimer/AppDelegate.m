...
//    }
//    if ([motionManager isGyroAvailable]){ NSLog(@"Gryro is available.");
//    } else {
//        NSLog(@"Gyro is not available."); }
//    if ([motionManager isGyroActive]){ NSLog(@"Gryo is active.");
//    } else {
//        NSLog(@"Gryo is not active."); }


    //[self.window makeKeyAndVisible];UITabBarController *tabBarController = (UITabBarController *)self.window.rootViewController;
    return YES;
}
